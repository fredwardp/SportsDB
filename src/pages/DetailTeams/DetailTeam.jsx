...
const DetailTeam = () => {
  ...
  return (
    <section className="container container-padding">
      {teams?.[0]?.strTeam && (
        <>
          <h1 className="team-name">{teams?.[0]?.strTeam || ""}</h1>
        </>
      )}
      <div className="header-flex">
        ...
        <div className="team-img">
          <img
            src="https://cdn.discordapp.com/attachments/1176890609542385764/1220380975985332265/w1anwa1588432105_1.png?ex=660ebb5a&is=65fc465a&hm=42d262ae8c46d99b03b2daa3fc9870490157dce9c5604549accbdcb697c89fbd&"
            alt="Image"
          />
        </div>
      </div>
      <div className="comp opensans">
        <div>
          <p className="detail-text">COMPETITIONS</p>
        </div>
        <div>
          {teams?.[0]?.strLeague && (
            <>
          ...
          {teams?.[0]?.strLeague2 && (
            <>
              <p className="detail-comp-text">{teams?.[0]?.strLeague2}</p>{" "}
              <br />
            </>
          )}{" "}
          {teams?.[0]?.strLeague3 && (
            <>
              <p className="detail-comp-text">{teams?.[0]?.strLeague3}</p>{" "}
              <br />
            </>
          )}{" "}
          {teams?.[0]?.strLeague4 && (
            <>
              <p className="detail-comp-text">{teams?.[0]?.strLeague4}</p>{" "}
              <br />
            </>
          )}{" "}
          {teams?.[0]?.strLeague5 && (
            <>
              <p className="detail-comp-text">{teams?.[0]?.strLeague5}</p>{" "}
              <br />
            </>
          )}
        </div>
      ...
      <div className="socials opensans">
        ...
        {teams?.[0]?.strFacebook && (
          <a
            className="opensans"
            target="_blank"
            href={"https://" + teams?.[0]?.strFacebook}
          >
            FACEBOOK
          </a>
        )}
        ...
        {teams?.[0]?.strInstagram && (
          <a
            className="opensans"
            target="_blank"
            href={"https://" + teams?.[0]?.strInstagram}
          >
            INSTAGRAM
          </a>
        )}
